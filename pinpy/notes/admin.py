...
class NotesAdmin(admin.ModelAdmin):
    list_display = ('id', 'title', 'slug', 'content', 'photo', 'time_create', 'time_update',
                    'is_published')  # Список полей, отображаемых в admin панели.
    ...
    list_filter = ('is_published', 'time_create')  # Поля, по которым можно фильтровать содержимое модели. 
